// src/components/ui/AxisLogo.tsx
...
export const AxisLogo: React.FC<AxisLogoProps> = ({ size = 'md' }) => {
  ...
  return (
    <div className={cn(sizes[size], "bg-[#1a1f24] flex items-center justify-center shadow-2xl overflow-hidden border border-slate-700")}>
      {/* 请将您上传的图片放入 public 目录并命名为 axis-logo.png */}
      <img src="/axis-logo.png" alt="Axis Logo" className="w-full h-full object-contain" />
    </div>
  );
};